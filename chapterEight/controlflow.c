 ...
 * controlflow.c
 *
 * "if" processing is done with two state variable
 ...
 * 	if in WAIT_THEN then syntax error (sh is different)
 */
{
...
/*
 * purpose: boolean to report if the command is s shell control command
 * returns: 0 or 1
 */
{
...
/*
 * purpose: handle syntax errors in control structures
